#!/bin/sh
# gcc-4.5.1-SPU-stage2.sh by Dan Peori (dan.peori@oopo.net)
...
## Configure the build.
../configure --prefix="$PS3DEV/spu" --target="spu" --disable-multilib --enable-checking="release" --enable-languages="c,c++" --with-newlib || { exit 1; }
